export const featureData = [
  ...
  {	
	...
	"Therefore, click on the 'Compliance' button to open all available quality paths and click on the clone button of the relevant quality path. The suggested quality path name can be modified. When confirming the action the cloning process is finished.",
	],
	imgs: [
